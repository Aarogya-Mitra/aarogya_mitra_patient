...
class ConsultationViaVoice extends StatefulWidget {
  const ConsultationViaVoice({super.key});

  @override
  State<ConsultationViaVoice> createState() => _ConsultationViaVoiceState();
}

class _ConsultationViaVoiceState extends State<ConsultationViaVoice> {
  /////////////////////////////////////////////////////////////////////////
  /// Text to speech
  ...
  Future<void> _createNewConsultation(
    // String title,
    String patientComplaintSummary,
  ) async {
    ...
    try {
      ...
      final consultation = Consultation(
        id: 'this will assign by firestore', // This will be assigned by Firestore
                  ...
                  child: IconButton(
                    onPressed: () {
                      if (speechToText.isNotListening) {
                        ...
                        textToSpeechFunction(
                          "Please stop speaking before sending your answer.",
                        );
                      }
                    },
